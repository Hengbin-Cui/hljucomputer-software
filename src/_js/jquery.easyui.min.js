...
(function($){
    ...
    function _88(_89){
        ...
        $("div.tree-node",_8b).unbind(".tree").bind("http://cstc.hrbeu.edu.cn/_js/dblclick.tree",function(){
            _123(_89,this);
            _8a.onDblClick.call(_89,_108(_89));
        }).bind("http://cstc.hrbeu.edu.cn/_js/click.tree",function(){
            _123(_89,this);
            _8a.onClick.call(_89,_108(_89));
        }).bind("http://cstc.hrbeu.edu.cn/_js/mouseenter.tree",function(){
            $(this).addClass("tree-node-hover");
            return false;
        }).bind("http://cstc.hrbeu.edu.cn/_js/mouseleave.tree",function(){
            $(this).removeClass("tree-node-hover");
            return false;
        }).bind("http://cstc.hrbeu.edu.cn/_js/contextmenu.tree",function(e){
            _8a.onContextMenu.call(_89,e,_b2(_89,this));
        });
        $("span.tree-hit",_8b).unbind(".tree").bind("http://cstc.hrbeu.edu.cn/_js/click.tree",function(){
            var _8c=$(this).parent();
            _e7(_89,_8c[0]);
            return false;
        }).bind("http://cstc.hrbeu.edu.cn/_js/mouseenter.tree",function(){
        ...
        }).bind("http://cstc.hrbeu.edu.cn/_js/mousedown.tree",function(){
            return false;
        });
        $("span.tree-checkbox",_8b).unbind(".tree").bind("http://cstc.hrbeu.edu.cn/_js/click.tree",function(){
            var _8d=$(this).parent();
...
(function($){
    function _236(_237){
        ...
        var _23b=parseInt(_238.find("http://cstc.hrbeu.edu.cn/_js/ul.tabs").css("padding-left"));
    ...
    function _258(_259){
        ...
        $(".tabs-scroller-left",_25a).unbind(".tabs").bind("http://cstc.hrbeu.edu.cn/_js/click.tabs",function(){
        ...
        $(".tabs-scroller-right",_25a).unbind(".tabs").bind("http://cstc.hrbeu.edu.cn/_js/click.tabs",function(){
            var wrap=$(".tabs-wrap",_25a);
        ...
        for(var i=0,len=tabs.length;i<len;i++){
            ...
            tab.unbind(".tabs").bind("http://cstc.hrbeu.edu.cn/_js/click.tabs",{
                p:_25c
            },function(e){
                _26a(_259,_25e(_259,e.data.p));
            }).bind("http://cstc.hrbeu.edu.cn/_js/contextmenu.tabs",{
                p:_25c
            },function(e){
                opts.onContextMenu.call(_259,e,e.data.p.panel("options").title);
            });
            tab.find("a.tabs-close").unbind(".tabs").bind("http://cstc.hrbeu.edu.cn/_js/click.tabs",{
                p:_25c
            },function(e){
    ...
    function _25f(_260,pp,_261){
        ...
        var tabs=$("http://cstc.hrbeu.edu.cn/_js/ul.tabs",_262);
...
(function($){
    ...
    function _2c6(_2c7,item){
        item.unbind(".menu");
        item.bind("http://cstc.hrbeu.edu.cn/_js/mousedown.menu",function(){
            return false;
        }).bind("http://cstc.hrbeu.edu.cn/_js/click.menu",function(){
        ...
        }).bind("http://cstc.hrbeu.edu.cn/_js/mouseenter.menu",function(e){
        ...
        }).bind("http://cstc.hrbeu.edu.cn/_js/mouseleave.menu",function(e){
    ...
    function _2cd(_2ce,pos){
        ...
        _2cf($(_2ce),{
            ...
            $(document).unbind(".menu").bind("http://cstc.hrbeu.edu.cn/_js/mousedown.menu",function(){
                _2cb(_2ce);
                $(document).unbind(".menu");
                return false;
            });
...
(function($){
    ...
    function _348(_349){
        ...
        var form=$(_349);
        form.unbind(".form").bind("http://cstc.hrbeu.edu.cn/_js/submit.form",function(){
            setTimeout(function(){
                _33a(_349,_34a);
            },0);
            return false;
