...
layer.prompt = function (g, f, j) {
    ...
    layer.photos = function (r) {
        var q, p, o, n, m, l, k, j, initialScale = 1, currentScale, dx, dy, px, py,
            ...
            q.event = function () {
                ...
                if (isSupportTouch) {
                    ...
                    if (typeof touch === "undefined") {
                        layer.use("extend/touch.min.js"/*tpa=http://cstc.hrbeu.edu.cn/_js/_portletPlugs/wp_photos/layer/extend/extend/touch.min.js*/, function () {
                            q.touch();
                        });
                    } else {
                        q.touch();
...
layer.use("skin/layer.ext.css"/*tpa=http://cstc.hrbeu.edu.cn/_js/_portletPlugs/wp_photos/layer/extend/skin/layer.ext.css*/,
    function () {
        layer.ext && layer.ext()
    });